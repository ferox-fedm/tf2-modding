...
void main() {
	...
	index = int(attrPositionIdx.w);
	
	vec3 bbMin = u_vmat.billboards[index].bbMinHeightOH.xyz;
	vec3 bbMax = u_vmat.billboards[index].bbMax.xyz;
	...
	fadeOutAlpha = compFadeOutAlpha(distToCam, u_vmat.fadeOutRanges[index]* vec2(u_view.lodFactor, 1.0 / u_view.lodFactor));
