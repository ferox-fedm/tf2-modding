...
void main() {
	...
	getBufTexInstAttrsColor(outData.instColor);

	//outData.texCoords = u_vmat.billboards[idx].texCoords;
	outData.texCoords[0] = u_vmat.billboards[idx].texCoords[0];
	outData.texCoords[1] = u_vmat.billboards[idx].texCoords[1];
	outData.texCoords[2] = u_vmat.billboards[idx].texCoords[2];
	outData.texCoords[3] = u_vmat.billboards[idx].texCoords[3];
	outData.texCoords[4] = u_vmat.billboards[idx].texCoords[4];
	outData.texCoords[5] = u_vmat.billboards[idx].texCoords[5];
	outData.texCoords[6] = u_vmat.billboards[idx].texCoords[6];
	outData.dimFadeIn = u_vmat.billboards[idx].dimFadeIn;
	outData.coordsOH = u_vmat.billboards[idx].coordsOH;
	outData.heightOH = u_vmat.billboards[idx].bbMinHeightOH.w;

	outData.bbMin = u_vmat.billboards[idx].bbMinHeightOH.xyz;
	outData.bbMax = u_vmat.billboards[idx].bbMax.xyz;
}
