...
LAYOUT_SAMPLER(2, 24) uniform sampler2D emissiveTex;
...
void main() {
	...
	vec3 col = u_mat.emissiveScale.xyz * pow(tex.rgb, vec3(2.2));

	fragmentOutputCustomColor(vec4(applyFog(col), texCoordAlpha.z));
}
