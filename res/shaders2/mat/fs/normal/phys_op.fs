...
void main() {
	...
	if (u_mat.opSettings1.y < 3) {
		albedo = applyOp(posAmbient.xyz, normal, texCoordAlpha.xy, opTex1, u_mat.opSettings1, u_mat.opScale1, u_mat.opOpacity1, albedo);
	}
	albedo = applyOp(posAmbient.xyz, normal, texCoordAlpha.xy, opTex2, u_mat.opSettings2, u_mat.opScale2, u_mat.opOpacity2, albedo);
