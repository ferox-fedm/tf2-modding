...
void main() {
	...
	col.rgb = applyOp(posAmbient.xyz, faceNormal, texCoord1, opTex1, u_mat.opSettings1, u_mat.opScale1, u_mat.opOpacity1, col.rgb);
	col.rgb = applyOp(posAmbient.xyz, faceNormal, texCoord1, opTex2, u_mat.opSettings2, u_mat.opScale2, u_mat.opOpacity2, col.rgb);
