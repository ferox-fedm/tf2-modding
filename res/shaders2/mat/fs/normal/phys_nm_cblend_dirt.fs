...
void main() {
	...
	vec3 albedoValue = texture(albedoTex, texCoordAlpha.xy).rgb * u_mat.albedoScales[0].xyz;
	...
	fragmentOutput(posAmbient.xyz, ambient, normal, albedo, metal, gloss, texCoordAlpha.z);
}
