...
INPUT(CBLEND_LOC, vec3, cblendColors[4], vec3(1.0));
...
void main() {
	...
	fragmentOutput(posAmbient.xyz, ambient, normal, albedo * u_mat.albedoScale, metalGlossAo.r, metalGlossAo.g, texCoordAlpha.z);
}
