...
LAYOUT_SAMPLER(2, 23) uniform sampler2D albedoGlossTex;
...
void main() {
	...
	fragmentOutput(posAmbient.xyz, ambient, normal, albedo * u_mat.albedoScales[0].xyz, metal, gloss, texCoordAlpha.z);
}
