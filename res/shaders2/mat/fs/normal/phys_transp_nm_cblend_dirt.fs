...
void main() {
	...
	vec3 albedo = colorBlend(col.rgb, cblendDirtRust.r, u_mat.cblendScale, cblendColor);
	...
	fragmentOutput(posAmbient.xyz, ambient, normal, albedo * u_mat.albedoScales[matIndex].xyz, metal, gloss, alpha);
}
