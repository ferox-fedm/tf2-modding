...
LAYOUT_SAMPLER(2, 23)  uniform sampler2D colorAlphaTex;
...
INPUT(COL_LOC, vec4, color, vec4(1.0));
...
void main() {
	...
	fragmentOutput(posAmbient.xyz, 1.0, normal, col.rgb, .0, .0, texCoordAlpha.z * col.a);
}
