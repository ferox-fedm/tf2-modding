...
soundsetutil.addTrackParam01(data, "vehicle/train_diesel/idle_drive.wav", 25.0,
		{ { .0, .45 }, { .05, .9 }, { 1.0, 1.0 } }, { { .0, 1.0 }, { .05, 1.1 }, { 1.0, 1.2 } }, "speed01")
...
soundsetutil.addEvent(data, "horn", { "vehicle/train_diesel/horn_24_Diesel.wav" }, 50.0)
