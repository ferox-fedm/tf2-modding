...
soundsetutil.addTrackParam01(data, "vehicle/waggon_old/_waggon_old.wav", 20.0,
...
soundsetutil.addEvent(data, "openDoors", { "vehicle/waggon_old/_waggon_old_opendoor.wav" }, 5.0)
soundsetutil.addEvent(data, "closeDoors", { "vehicle/waggon_old/_waggon_old_closedoor.wav" }, 5.0)
