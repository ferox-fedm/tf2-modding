function data()
return {
	colorTexture = "terrain/grass/grass_dark_green_albedo_opacity.dds",
	...
	translucencyTexture = "terrain/grass/grass_dark_green_translucency.dds",
	materials = {"tropical/grass_dark_green.lua"},
