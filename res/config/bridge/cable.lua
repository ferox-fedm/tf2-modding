...
local dir = "bridge/cable/"

local pillarTargetDist = 132 -- 252.0
local pillarMinDist = 12.0
local longTolerance = 33.0 -- 45.0
local longMaxCurvature = 1.0 / 180.0 -- 1 / radius [m]

local input = {
	pillarBig = {
		pillarBase = { dir .. "pillar_btm_side.mdl", dir .. "pillar_btm_rep.mdl", dir .. "pillar_btm_side_2.mdl" },
		pillarRepeat = { dir .. "pillar_rep_side.mdl", dir .. "pillar_rep_rep.mdl", dir .. "pillar_rep_side_2.mdl" },
	...
	railingRepeat = {
		...
		dir .. "railing_rep_side_2.mdl",  dir .. "railing_rep_side_2.mdl",  dir .. "railing_rep_side_2_no_side.mdl",
	},
	railingLongBegin = {
...
local updateFn = function(params)
	...
	for i = 1, #params.railingIntervals do
		...
		intervalData[i] = {
			railingBegin = interval.hasPillar[1] >= 0 and input.railingRepeat
	 or { },
			railingRepeat = input.railingRepeat
	,
			railingEnd = interval.hasPillar[2] >= 0 and input.railingRepeat
	 or { },
	...
	for i = 1, #params.railingIntervals do
		...
		if remLen < interval.length and remLen <= tolerance then data.railingRepeat = { } end
	end
