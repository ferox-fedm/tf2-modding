...
local firstNamesMale = names.germany.english.firstNamesMale
local firstNamesFemale = names.germany.english.firstNamesFemale
local lastNames = names.germany.english.lastNames
