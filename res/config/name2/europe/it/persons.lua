...
local firstNamesMale = names.italy.english.firstNamesMale
local firstNamesFemale = names.italy.english.firstNamesFemale
local lastNames = names.italy.english.lastNames
